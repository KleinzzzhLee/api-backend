...
public class UserInterfaceInfoController {
    ...
    public BaseResponse<Long> addUserInterfaceInfo(@RequestBody InterfaceInfoAddRequest userInterfaceInfoAddRequest, HttpServletRequest request) {
...
//        boolean result = userInterfaceInfoService.save(userInterfaceInfo);
    ...
    public BaseResponse<List<UserInterfaceInfo>> listUserInterfaceInfo(UserInterfaceInfoQueryRequest userInterfaceInfoQueryRequest) {
        ...
        QueryWrapper<UserInterfaceInfo> wrapper = new QueryWrapper<>(userInterfaceInfo);
    ...
    public BaseResponse<Page<UserInterfaceInfo>> listUserInterfaceInfoByPage(UserInterfaceInfoQueryRequest userInterfaceInfoQueryRequest, HttpServletRequest request) {
        ...
        Page<UserInterfaceInfo> result = userInterfaceInfoService.page(page);
        return ResultUtils.success(result);
    }
}
